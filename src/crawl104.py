...
def get_test_url():
    url = 'https://www.104.com.tw/jobs/search//?jobsource=2018indexpoc&ro=1&page={}'
    url = url + "&keyword=" + keyword
    url = url + "&jobcat=" + "2007000000"
    url = url + "&indcat=" + "1004000000"
    url = url + "&area=" + "6001001000"
...
def get_filename(sitename,keyword):
...
#############################################################################    
    filename = get_filename(sitename,keyword)
    all_jobs = start_crawl(url_constructor(keyword=keyword))
    ...
    column_dict = {
        ...
        'salary':'工作待遇', 'category':'職務類別', 'tool':'擅長工具',  'address':'上班地點',
        'nature':'工作性質','manage':'管理責任',
        'travel':'出差外派','working':'上班時段','vacation':'休假制度','availability':'可上班日','required':'需求人數',
